            ...
            for(int jh=-descriptorRadius; jh<descriptorRadius; jh++)
            {
                ...
                for(int ig=-histogramRadius; ig<histogramRadius; ig++)
                {
                    for(int jg=-histogramRadius; jg<histogramRadius; jg++)
                    {
                        ...
                        pointDescriptor.addToBasket(currHist, basket1, currMagnitude*b1Weight * gaussKernel[histogramRadius+ig][histogramRadius+jg]);
                        pointDescriptor.addToBasket(currHist, basket2, currMagnitude*b2Weight * gaussKernel[histogramRadius+ig][histogramRadius+jg]);
                    }
                }
                currHist++;
            }
